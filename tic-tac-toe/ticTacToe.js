...
(function ($) {
	$.widget("ui.ticTacToe", {
		...
		css: {
			...
			table: "tic-tac-toe",
			/* Class applied to the cell that is clicked. */
			clicked: "clicked"
		},
			...
			if (buttonType) {
				switch (buttonType) {
					...
					case "reset": {
						...
						//this.vars._arrayCells = [];
						$(this.element.find("." + this.css.table)).igNotifier("destroy");
					}
						break;
				}
			}
		...
		_makeMoves: function(element, gameEnded, arrayCells) {
			var turn = 0;
			if (turn === 0 && $(element).children()[ 0 ] === undefined) {
				var span = $("<span></span>").addClass(this.css.firstPlayer);
				$(element).addClass(this.css.clicked).append(span);
		...
		_applyFirstColor: function(appendSpan) {
		...
		compMove: function (turn, gameEnded, arrayCells) {
			...
			for (var p = 0; p < 9; p++) {
				if (p >= 0 && p < 3) {    //check vertical for first row
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p + 3 ].children().html() === arrayCells[ p + 6 ].children().html() &&
					arrayCells[ p + 3 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
						flag = false;
						return;
					} else if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p + 3 ].children().html() === arrayCells[ p + 6 ].children().html() &&
					arrayCells[ p + 3 ].children().html() === self.options.firstPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
				...
				if (p >= 3 && p < 6) {   //check vertical for second row
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p + 3 ].children().html() === arrayCells[ p - 3 ].children().html() &&
					arrayCells[ p + 3 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
				...
				if (p === 1 || p === 4 || p === 7) {     //check horizontal for seond column
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p - 1 ].children().html() === arrayCells[ p + 1 ].children().html() &&
					arrayCells[ p - 1 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
					...
					(arrayCells[ p - 1 ].children().html() === arrayCells[ p + 1 ].children().html() &&
					arrayCells[ p - 1 ].children().html() === self.options.firstPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
				...
				if (p === 2 || p === 5 || p === 8) {      //check horizontal for third column
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p - 1 ].children().html() === arrayCells[ p - 2 ].children().html() &&
					arrayCells[ p - 1 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
				...
				if (p === 0) {
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p + 4 ].children().html() === arrayCells[ p + 8 ].children().html() &&
					arrayCells[ p + 4 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
					...
					(arrayCells[ p + 4 ].children().html() === arrayCells[ p + 8 ].children().html() &&
					arrayCells[ p + 4 ].children().html() === self.options.firstPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
				...
				if (p === 2) {
					if (arrayCells[ p ].children().html() === undefined &&
					(arrayCells[ p + 2 ].children().html() === arrayCells[ p + 4 ].children().html() &&
					arrayCells[ p + 2 ].children().html() === self.options.secondPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
					...
					(arrayCells[ p + 2 ].children().html() === arrayCells[ p + 4 ].children().html() &&
					arrayCells[ p + 2 ].children().html() === self.options.firstPlayer)) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
						turn = 0;
				...
				if (p === 4) {
					if (arrayCells[ p ].children().html() === undefined &&
					((arrayCells[ p + 2 ].children().html() === arrayCells[ p - 2 ].children().html() &&
					arrayCells[ p - 2 ].children().html() === self.options.secondPlayer) ||
					(arrayCells[ p + 4 ].children().html() === arrayCells[ p - 4 ].children().html() &&
					arrayCells[ p - 4 ].children().html() === self.options.secondPlayer))) {
						$(arrayCells[ p ]).addClass(self.css.clicked).append(span);
						self._applysecondColor(span);
						self._setSecondPlayerIndex(span);
			...
			if (flag) {
				var rndCell = self._getRandomCell();
				if (arrayCells[ rndCell ].children().html() === undefined) {
					$(arrayCells[ rndCell ]).addClass(self.css.clicked).append(span);
					self._applysecondColor(span);
					self._setSecondPlayerIndex(span);
					turn = 0;
					return;
				} else {
					if (arrayCells[ rndCell + 1 ].children().html() === undefined) {
						$(arrayCells[ rndCell + 1 ]).addClass(self.css.clicked).append(span);
						self._setSecondPlayerIndex(span);
						self._applysecondColor(span);
						turn = 0;
						return;
		...
		_alertGameEndFirstPlayerWin: function () {
		    $(this.element.find("." + this.css.table)).igNotifier({
				messages: {
					success: "Congrads, you win!"
				},
				mode: "popover",
				direction: "right",
				closeOnBlur: true
		...
		checkWin: function (gameEnded, arrayCells) {
			...
			if (jQuery.inArray("", arrayOfSpans) !== -1) {
				//vertical
				for (var u = 0; u <= 2; u++) {
					if (arrayCells[ u ].children().html() === arrayCells[ u + 3 ].children().html() &&
						arrayCells[ u ].children().html() === arrayCells[ u + 6 ].children().html() &&
						arrayCells[ u ].children().html() === this.options.firstPlayer) {
						gameEnded = true;
						this._alertGameEndFirstPlayerWin();
						return gameEnded;
					} else if (arrayCells[ u ].children().html() === arrayCells[ u + 3 ].children().html() &&
						arrayCells[ u ].children().html() === arrayCells[ u + 6 ].children().html() &&
						arrayCells[ u ].children().html() === this.options.secondPlayer) {
						gameEnded = true;
				...
				for (var h = 0; h < 6; h = h + 3) {
					if (arrayCells[ h ].children().html() === arrayCells[ h + 1 ].children().html() &&
						arrayCells[ h ].children().html() === arrayCells[ h + 2 ].children().html() &&
						arrayCells[ h ].children().html() === this.options.firstPlayer) {
						gameEnded = true;
						this._alertGameEndFirstPlayerWin();
						return gameEnded;
					} else if (arrayCells[ h ].children().html() === arrayCells[ h + 1 ].children().html() &&
						arrayCells[ h ].children().html() === arrayCells[ h + 2 ].children().html() &&
						arrayCells[ h ].children().html() === this.options.secondPlayer) {
						gameEnded = true;
						this._alertGameEndSecondPlayerWin();
						return gameEnded;
				...
				//diagonals
				if (arrayCells[ 0 ].children().html() === arrayCells[ 4 ].children().html() &&
					arrayCells[ 0 ].children().html() === arrayCells[ 8 ].children().html() &&
					arrayCells[ 0 ] === this.options.firstPlayer) {
					gameEnded = true;
					this._alertGameEndFirstPlayerWin();
					return gameEnded;
				} else if (arrayCells[ 0 ].children().html() === arrayCells[ 4 ].children().html() &&
					arrayCells[ 0 ].children().html() === arrayCells[ 8 ] &&
					arrayCells[ 0 ].children().html() === this.options.secondPlayer) {
					gameEnded = true;
					this._alertGameEndSecondPlayerWin();
					return gameEnded;
				}

				if (arrayCells[ 2 ].children().html() === arrayCells[ 4 ].children().html() &&
					arrayCells[ 2 ].children().html() === arrayCells[ 6 ].children().html() &&
					arrayCells[ 2 ].children().html() === this.options.firstPlayer) {
					gameEnded = true;
					this._alertGameEndFirstPlayerWin();
					return gameEnded;
				} else if (arrayCells[ 2 ].children().html() === arrayCells[ 4 ].children().html() &&
					arrayCells[ 2 ].children().html() === arrayCells[ 6 ].children().html() &&
					arrayCells[ 2 ].children().html() === this.options.secondPlayer) {
					gameEnded = true;
					this._alertGameEndSecondPlayerWin();
					return gameEnded;
				}
